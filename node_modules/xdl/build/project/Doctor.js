...
exports.validateExpoServersAsync = exports.validateWithNetworkAsync = exports.validateWithoutNetworkAsync = exports.FATAL = exports.ERROR = exports.WARNING = exports.NO_ISSUES = void 0;
...
async function _validateReactNativeVersionAsync(exp, pkg, projectRoot, sdkVersions, sdkVersion) {
    ...
    if (internal_1.Versions.gteSdkVersion(exp, '41.0.0') &&
        ((_d = pkg.dependencies) === null || _d === void 0 ? void 0 : _d['@react-native-community/async-storage'])) {
